...
The Gem installs roll20-dm-mcp as a dependency at a fixed tag — currently **`#v2.0.0`** — and builds it in its
...
`[GM_AI_Bridge] Relay script loaded (v2.4.0)`. Saving is not loading. See **[Setup](Setup)** step 3.
