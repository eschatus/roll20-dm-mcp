...
1. The browser window will appear. Navigate to `roll20.net` and sign in.
...
In Claude Code (after completing step 7 below), run:
...
If the DDB tools return errors, check that you're logged into DDB in the Playwright browser (see step 5).
